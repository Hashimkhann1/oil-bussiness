...
class AllCustomerView extends StatefulWidget {
  AllCustomerView({super.key});

  @override
  State<AllCustomerView> createState() => _AllCustomerViewState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // All Customers
          FutureBuilder(
              future: FirebaseFirestore.instance.collection('users').doc(userData.adminId).collection('customers').get(),
